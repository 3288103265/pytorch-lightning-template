...
class CocoDataset(CocoSceneGraphDataset):
    def __init__(self, image_size, train=False):
        if train == True:
            self.kwargs = dict(
                ...
                stuff_only=True, image_size=(image_size, image_size), left_right_flip=True
            )
        else:
            self.kwargs = dict(
                ...
                stuff_only=True, image_size=(image_size, image_size), left_right_flip=False
            )
